...
const Profile = () => {
	return (
		<>
			<section className=" ">
				<div className="container bg-white dark:bg-slate-800 mx-auto  rounded shadow-md">
					<div className="p-6 h-full overflow-hidden ">
						<div className="pb-6 border-b border-gray-100 dark:border-gray-700">
							<div className="flex flex-wrap items-center justify-between -m-2">
								<div className="w-full md:w-auto p-2">
									<h2 className="text-coolGray-800    text-lg font-semibold">
										Personal info
									</h2>
								...
								<div className="w-full md:w-auto ">
									<div className="flex flex-wrap justify-between -m-1.5">
										<div className="w-full md:w-auto p-1.5">
											<button className=" flex flex-wrap justify-center w-full px-4 py-2 font-medium text-sm text-coolGray-500 hover:text-coolGray-600 border border-gray-200 dark:border-none hover:border-coolGray-300 bg-white rounded-md shadow-button">
												<p>Cancel</p>
											</button>
										</div>
										<div className="w-full md:w-auto p-1.5">
											{/* <button class="flex flex-wrap justify-center w-full px-4 py-2 bg-gray-800 hover:bg-gray-700 font-medium text-sm text-white border border-gray-500 rounded-md shadow-button">
                  <p>Save</p>
                </button> */}
											<button className=" flex flex-wrap justify-center w-full px-4 !py-2 font-medium text-sm text-coolGray-500 hover:text-coolGray-600 border border-gray-200 dark:border-none hover:border-coolGray-300 bg-indigo-500 text-white rounded-md shadow-button">
												<p>Save</p>
											</button>
										</div>
									</div>
						...
						<div className="py-6 border-b border-gray-100 dark:border-gray-700">
							<div className="w-full md:w-9/12">
								<div className="flex flex-wrap -m-3">
									...
									<div className="w-full md:flex-1 p-3">
										<div className="relative flex flex-col items-center justify-center p-6 h-44 text-center text-gray-500 focus-within:border-blue-400 border border-dashed border-gray-200 dark:border-gray-500 rounded-lg">
											<svg
												className="mb-1.5"
												width="24"
												height="24"
								...
								<div className="flex flex-wrap -m-3">
									...
									<div className="w-full md:flex-1 p-3">
										<div className="relative">
											...
											<select className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300">
						...
						<div className="pt-6">
							<div className="w-full md:w-9/12">
								<div className="flex flex-wrap -m-3">
									...
									<div className="w-full md:flex-1 p-3">
										<textarea className="block w-full h-64 dark:border-gray-600 p-6 text-base text-gray-900 font-normal outline-none dark:bg-gray-800 focus:border-blue-400 border border-gray-200 rounded-lg shadow-input resize-none"></textarea>
									</div>
								</div>
							</div>
						</div>
